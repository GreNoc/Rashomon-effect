...
const questions : LikertQuestion[] = [
    ...
    {id: "AC2", question: "6. **Please select 'strongly disagree' for this item to show that you are reading carefully.**", isAttentionCheck: false},
    {id: "PCE6", question: "7. **The task of generating insights using the AI prediction model was too complex.**", isAttentionCheck: false},
]
